package com.jornah.txcloud.sms;
...
import com.tencentcloudapi.sms.v20190711.models.CallbackStatusStatisticsRequest;
import com.tencentcloudapi.sms.v20190711.models.CallbackStatusStatisticsResponse;

/**
 * Tencent Cloud Sms CallbackStatusStatistics
...
public class CallbackStatusStatistics {
    public static void main(String[] args) {
        try {
            ...
            Long enddatatime = null;
            req.setEndDataTime(enddatatime);

            /* 通过 client 对象调用 CallbackStatusStatistics 方法发起请求。注意请求方法名与请求对象是对应的
             * 返回的 res 是一个 CallbackStatusStatisticsResponse 类的实例，与请求对象对应 */
            // CallbackStatusStatisticsResponse res = client.CallbackStatusStatisticsStatus(req);
            CallbackStatusStatisticsResponse res = client.CallbackStatusStatistics(req);

            // 输出json格式的字符串回包
            System.out.println(CallbackStatusStatisticsResponse.toJsonString(res));
