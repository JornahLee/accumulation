...
import com.tencentcloudapi.sms.v20190711.models.SmsPackagesStatisticsRequest;
import com.tencentcloudapi.sms.v20190711.models.SmsPackagesStatisticsResponse;

/**
 * Tencent Cloud Sms SmsPackagesStatistics
...
public class SmsPackagesStatistics {
    public static void main(String[] args) {
        try {
            ...
            // 输出json格式的字符串回包
            System.out.println(SmsPackagesStatisticsResponse.toJsonString(res));
